...
CREATE TABLE [UTL].[DB_EXCEPTION_TANK](
...
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'This table will hold generic exception data from stored procedured with Try/Catch implementation until such time
        that Mezrah specific exceptions can be created --Dave Babler' , @level0type=N'SCHEMA',@level0name=N'UTL', @level1type=N'TABLE',@level1name=N'DB_EXCEPTION_TANK'
GO
